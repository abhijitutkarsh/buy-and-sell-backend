      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              id = req.params.id; // const listing = fakeListings.find(listing => listing.id ===id);

              _context.next = 3;
              return _database.db.query('SELECT * FROM listings WHERE id=?', [id] //prevents sql injection by entering DROP TABLE listings 
              );
